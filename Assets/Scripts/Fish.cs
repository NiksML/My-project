...
public class Fish : MonoBehaviour
{
    ...
    IEnumerator SwimingWithoutPlayer(float waittime)
    {
        ...
        //ѕроверка может ли рыба двигатьс€ вверх
        ...
        //ѕроверка может ли рыба двигатьс€ вниз
        ...
        //ѕроверка может ли рыба двигатьс€ влево
        ...
        //ѕроверка может ли рыба двигатьс€ вправо
        ...
        {
            case (true,true,true,true): // сработает если можем двигатьс€ во все стороны
                do
                {
            ...
            case (false, true, true, true): // сработает если не можем двигатьс€ вниз
                do
                {
            ...
            case (false, true, false, true): // сработает если не можем двигатьс€ вниз и вправо
                do
                {
            ...
            case (false, false, true, true): // сработает если не можем двигатьс€ вниз и влево
                do
                {
            ...
            case (true, true, true, false): // сработает если не можем двигатьс€ вверх
                do
                {
            ...
            case (true, true, false, false): // сработает если не можем двигатьс€ вверх и вправо
                do
                {
            ...
            case (true, false, true, false): // сработает если не можем двигатьс€ вверх и влево
                do
                {
            ...
            case (true, false, true, true): // сработает если не можем двигатьс€ влевоЄ
                do
                {
            ...
            case (true, true, false, true): // сработает если не можем двигатьс€ вправо
                do
                {
